...
<body>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/doc.jpg);">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 wow fadeInUp">
            ...
            <p class="text-grey mb-4">We can help you here with many health matters To contact us you can write to use </span>to inquire about any health information and you can visit our </span>health if necessary to maintain your health</p>
            <a href="about.html" class="btn btn-primary">Learn More</a>
          </div>
          <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
            <div class="img-place custom-img-1">
              <img src="../assets/img/asd.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          ...
          <a href="#" class="footer-link">7123 564488 11</a>
          <a href="#" class="footer-link">admin@gmail.com</a>
